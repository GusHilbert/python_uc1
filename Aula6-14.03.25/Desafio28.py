...
while resposta != "4":
    if resposta == "1":
        ...
        4 - Saír
        """)
        resposta = input("\nDigite o número relativo a sua solicitação: ")
...
if len (exercicio) ==0 and len (duvida) == 0 and len(erro) == 0: 
    print("""Desculpa não poder ter te ajudado =/
          Até a próxima""")
elif len (exercicio) !=0 and len (duvida) != 0 and len(erro) == 0: 
    print("""Seu exercício e dúvida foram enviados com sucesso =)
          Até a próxima""")
elif len (exercicio) ==0 and len (duvida) != 0 and len(erro) != 0: 
    print("""Sua dúvida e erro foram enviados com sucesso =)
          Até a próxima""")
elif len (exercicio) !=0 and len (duvida) == 0 and len(erro) != 0: 
    print("""Seu exercício e erro foram enviados com sucesso =)
          Até a próxima""")
elif len (exercicio) !=0 and len (duvida) == 0 and len(erro) == 0: 
    print("""Seu exercício foi enviado com sucesso =)
          Até a próxima""")
elif len (exercicio) ==0 and len (duvida) != 0 and len(erro) == 0: 
    print("""Sua dúvida foi enviada com sucesso =)
          Até a próxima""")
elif len (exercicio) ==0 and len (duvida) == 0 and len(erro) != 0: 
    print("""Seu erro foi enviado com sucesso =)
          Até a próxima""")